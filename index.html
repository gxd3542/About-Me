...
<html lang="en">
	<head>
		...
		<title>About Gage Dunn</title>
		<meta name="viewport" content="width=device-width, initial-scale=1">
		<link rel="shortcut icon" href="fat cat.ico">
	</head>
	<body>
		<style>
		...
		<div class="overlay overlay_dark">
			<main class="project">
				<h1 id="fit" class="project__name project__name_shadow">Gage Dunn</h1>

				<ul class="project__list">
					<li class="project__item">
						<a class="project__link project__link_empty">Classes</a> 
						<ul class="project__list">
							<li class="project__item">
								<a href="#" class="project__link">Intro to Sys Admin & Shell</a>
							</li>
							<li class="project__item">
								<a href="#" class="project__link">Introduction to Cybersecurity</a>
							</li>
							<li class="project__item">
								<a href="#" class="project__link">Network Architecture And Protocols</a>
							</li>
							<li class="project__item">
								<a href="#" class="project__link">Software Development & Professional Practices</a>
							</li>
							<li class="project__item">
								<a href="#" class="project__link">World Literature Before 1660</a>
							</li>
						</ul>
					</li>
					 <li class="project__item">
						<a class="project__link project__link_empty">What should you know about me?</a> 
						<ul class="project__list">
							<li class="project__item">
								<a href="#" class="project__link">Loves video games</a>
							</li>
							<li class="project__item">
								<a href="#" class="project__link">Currently a UNCP tutor</a>
							</li>
							<li class="project__item">
								<a href="#" class="project__link">Own two (and love) cats</a>
							</li>
						</ul>
					</li>
				</ul>
